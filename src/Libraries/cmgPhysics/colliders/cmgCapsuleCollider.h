#ifndef _CMG_PHYSICS_COLLIDERS_CAPSULE_COLLIDER_H_
#define _CMG_PHYSICS_COLLIDERS_CAPSULE_COLLIDER_H_
...
{
public:
	CapsuleCollider(float radius, float halfHeight, const Matrix4f& offset = Matrix4f::IDENTITY);
...
#endif // _CMG_PHYSICS_COLLIDERS_CAPSULE_COLLIDER_H_